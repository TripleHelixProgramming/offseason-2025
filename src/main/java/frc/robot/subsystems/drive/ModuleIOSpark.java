...
public class ModuleIOSpark implements ModuleIO {
  ...
  public ModuleIOSpark(int module) {
    ...
    turnEncoderAbsolute =
        new CANcoder(
            switch (module) {
              case 0 -> frontLeftTurnAbsoluteEncoderCanId;
              case 1 -> frontRightTurnAbsoluteEncoderCanId;
              case 2 -> backLeftTurnAbsoluteEncoderCanId;
              case 3 -> backRightTurnAbsoluteEncoderCanId;
              default -> 0;
            });
    ...
    tryUntilOk(
        ...
        () ->
            turnEncoder.setPosition(
                new Rotation2d(turnEncoderAbsolute.getAbsolutePosition().getValue()).getRadians()));
  }
  ...
  public Rotation2d getAbsTurningPosition(double waitPeriod) {
    ...
    if (waitPeriod > 0.0) {
      absPositonRotations =
          turnEncoderAbsolute.getAbsolutePosition().waitForUpdate(waitPeriod).getValue();
    } else {
      absPositonRotations = turnEncoderAbsolute.getAbsolutePosition().getValue();
    }
